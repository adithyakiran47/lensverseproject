      ...
      <div className="container py-4 bg-black text-white min-vh-100">
        ...
        <form onSubmit={handleSubmit} className="bg-dark p-4 rounded shadow-lg">
          ...
          <div className="mb-3">
            ...
            <input type="text" name="serviceType" className="form-control bg-black text-white" id="serviceType" required value={formData.serviceType} onChange={handleChange} />
          </div>
          <div className="mb-3">
            <label htmlFor="date" className="form-label">Date</label>
            <input type="date" name="date" className="form-control bg-black text-white" id="date" required value={formData.date} onChange={handleChange} />
          </div>
