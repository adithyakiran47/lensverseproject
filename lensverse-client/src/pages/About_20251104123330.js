...
const CREATORS = [
  {
    name: "Creator Name 1", // Replace with actual name
    ...
    image: "http://localhost:5000/assets/ak (1).JPG", // Add creator's image to public folder
    social: {
  ...
  {
    name: "Creator Name 2", // Replace with actual name
    ...
    image: "/creator2.jpg", // Add creator's image to public folder
    social: {
