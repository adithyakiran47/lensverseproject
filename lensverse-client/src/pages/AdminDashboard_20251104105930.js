      ...
      <div className="container bg-black text-white py-5 min-vh-100">
        <div className="d-flex align-items-center justify-content-between mb-4">
          ...
          <div className="d-flex gap-2 align-items-center">
            <input className="form-control form-control-sm bg-dark text-white" style={{ minWidth: 220 }}
              placeholder="Search by name, email, service..." value={search} onChange={e => setSearch(e.target.value)} />
        ...
        <div className="table-responsive d-none d-md-block">
          <table className="table table-dark table-hover align-middle">
            <thead>
              <tr>
                <th>Name</th><th>Email</th><th>Service</th><th>Date</th><th>Status</th><th style={{ width: 260 }}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map(b => (
