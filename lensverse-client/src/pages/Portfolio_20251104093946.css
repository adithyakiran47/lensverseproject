  ...
  const categories = [
    {
      ...
      image: 'https://your-bucket.s3.amazonaws.com/portfolio/events/cover.jpg',
      description: 'Corporate events, weddings, and special occasions captured with precision and style.',
    },
    {
      id: 'automotive',
      title: 'Automotive',
      image: 'https://your-bucket.s3.amazonaws.com/portfolio/automotive/cover.jpg',
                ...
                <div className="category-card card bg-black text-white h-100 border-0">
                  <div className="card-image-wrapper">
                    ...
                    <div className="card-overlay">
                      <Link to={`/portfolio/${category.id}`} className="btn btn-outline-light">
                        View Gallery
                      </Link>
                    </div>
                  </div>
